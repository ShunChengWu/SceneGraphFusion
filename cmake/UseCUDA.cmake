...
IF(WITH_CUDA)
  ...
  #  SET(CMAKE_CUDA_COMPILER:PATH=/usr/local/cuda/bin/nvcc)
  ...
  ENDIF()
    ...
    message("CUDA_COMPUTE_CAPABILITY: " ${CUDA_COMPUTE_CAPABILITY})
  ...
  MESSAGE("COMPILE_WITH_CUDA")
  ADD_DEFINITIONS(-DCOMPILE_WITH_CUDA)
ELSE()
  MESSAGE("COMPILE_WITHOUT_CUDA")
