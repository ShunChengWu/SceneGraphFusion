...
#define M_SENSOR_DATA_VERSION 4
		...
		void saveToImages(const std::string& outputFolder, const std::string& basename = "frame-") const {
...

			{
				...
				for (unsigned int i = 0; i < 16; i++) outMeta << m_calibrationColor.m_intrinsic.matrix[i] << " ";
				outMeta << "\n";
				outMeta << "m_calibrationColorExtrinsic" << " = ";
				for (unsigned int i = 0; i < 16; i++) outMeta << m_calibrationColor.m_extrinsic.matrix[i] << " ";
				outMeta << "\n";
				outMeta << "m_calibrationDepthIntrinsic" << " = ";
				for (unsigned int i = 0; i < 16; i++) outMeta << m_calibrationDepth.m_intrinsic.matrix[i] << " ";
				outMeta << "\n";
				outMeta << "m_calibrationDepthExtrinsic" << " = ";
				for (unsigned int i = 0; i < 16; i++) outMeta << m_calibrationDepth.m_extrinsic.matrix[i] << " ";
				outMeta << "\n";
